...
class RankitDummy {
	...
	new() {
		...
		calificacion2 = new Calificacion(8, "muy caro", usuario1.nombre, cablevision.nombre)
		...
		calificacion6 = new Calificacion(9, "Ningun problema con el servicio", usuario1.nombre, correoARG.nombre)
