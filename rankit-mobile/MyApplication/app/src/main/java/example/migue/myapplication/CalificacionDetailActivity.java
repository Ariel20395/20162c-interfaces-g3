...
public class CalificacionDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(CalificacionDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(CalificacionDetailFragment.ARG_ITEM_ID));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, CalificacionListActivity.class));
            return true;
        }
