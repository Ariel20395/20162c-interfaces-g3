package example.migue.myapplication;
...
import example.migue.myapplication.dummy.DummyContent;
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(CalificacionDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        Intent intent = new Intent(context, CalificacionDetailActivity.class);
                        intent.putExtra(CalificacionDetailFragment.ARG_ITEM_ID, holder.mItem.id);
